...
#
# Usage (recommended - use new canonical path):
...
#   progress_summary
#
# Legacy path (deprecated, use new path above):
#   source scripts/utils/progress-tracker.sh  # Symlink for backward compatibility
#
# Features:
