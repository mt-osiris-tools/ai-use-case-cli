...
echo -e "  ${GREEN}ai-use-case push${NC}              Push hub changes to remote"
echo -e "  ${GREEN}ai-use-case publish-confluence${NC} Publish to Confluence"
echo -e "  ${GREEN}ai-use-case search <term>${NC}    Search use cases"
echo -e "  ${GREEN}ai-use-case view${NC}              View hub in file explorer"
echo -e "  ${GREEN}ai-use-case list${NC}              List all projects"
echo -e "  ${GREEN}ai-use-case stats${NC}             View statistics"
echo -e "  ${GREEN}ai-use-case --help${NC}            Show detailed help"
echo ""
