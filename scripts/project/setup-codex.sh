...
echo ""
echo -e "${YELLOW}Migration guidance:${NC} If you previously used project-local .codex/prompts/ directories,"
echo "those are no longer used by default. You may have prompts in both your home directory"
echo "and in old project-local .codex directories until you manually clean up."
echo "To avoid confusion, you can safely delete any .codex/prompts/ directories from your project roots."
echo ""
