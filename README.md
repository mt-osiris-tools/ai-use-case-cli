...
3. **Document your session** (in Claude Code):
   ...
   **v3.10.0+**: Checklist appears first, then asks what to scan (conversation/git/both) before running any bash commands.
...
2. **Document**: `/use-case:document-session` shows checklist → asks what to scan → presents options → you select → automatic generation with real-time progress
